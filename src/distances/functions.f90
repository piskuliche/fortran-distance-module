    ...
    !
        ...
        EndDo
        ! Calculate distance
        dr = sqrt(dot_product(dr_tmp,dr_tmp))
        ! Assign values to dr_arr and get unit vector
        dr_arr(1:3) = dr_tmp(1:3)
    ...
    function periodic_distance_and_unit_vector(r1, r2, box) result(dr_arr)
    ! This function calculates the square of the distance between two atoms
    ! in a periodic system.
    !
    ! Inputs:
    ...
    end function periodic_distance_and_unit_vector
    ...
    dr12 = 0.0; dr23 = 0.0
    dr12 = periodic_distance_and_unit_vector(r2, r1, box)
    dr23 = periodic_distance_and_unit_vector(r2, r3, box)
